    ...
    0x1f, 0x9f, 0x5f, 0xdf, 0x3f, 0xbf, 0x7f, 0xff
        ...
        public GameField LadeSpielfeld(byte[] information)
        {
            ...
            while (i < information.Length)
            {
                ...
                {
                    case Operation.VCTR:
                        VCTR vctr = new VCTR(word, new BitArray(new byte[] { information[i + 2], information[i + 3] }));
                        i += 4;
                        break;
                    case Operation.LABS:
                        i += 4;
                        LABS labs = new LABS(word, new BitArray(new byte[] { information[i + 2], information[i + 3] }));
                        break;
                    case Operation.HALT:
                        i += 2;
                        break;
